            ...
            <form id="signupForm" novalidate action="/auth/register/addition" method="post">
                ...
                <!-- 약관 동의 -->
                    <div class="terms-box">
                        ...
                        <p>
                            회원가입을 위해 입력하신 이메일, 아이디, 닉네임 등은 계정 생성 및 본인 확인 목적으로 사용됩니다.
                            수집된 개인정보는 서비스 제공, 공지사항 전달, 고객 문의 대응, 보안 유지 등의 목적에 한해 이용되며
                            법령에서 정한 기간 동안 안전하게 보관됩니다.<br><br>
                            또한 이용자는 언제든지 개인정보 열람, 수정, 삭제를 요청할 수 있으며, 관련 법규에 따라 필요한 경우 회원 계정이 제한될 수 있습니다.<br><br>
                            자세한 내용은 이용약관 및 개인정보 처리방침을 확인해 주세요.
                        </p>
                    </div>
                <div class="field">
                    <label class="switch">
